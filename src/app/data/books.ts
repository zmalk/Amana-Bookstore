...
export const books: Book[] = [
  ...
  author: 'Prof. Sara Al-Jabir',
  description: 'A beginner-friendly guide to artificial neural networks, covering fundamentals, training algorithms, and practical applications in AI.',
  price: 99.95,
  ...
  pages: 512,
  language: 'English',
  publisher: 'Al-Khawarizmi AI Press',
  rating: 4.7,
  reviewCount: 10,
  inStock: true,
  featured: true,
